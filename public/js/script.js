    ...
    if ($('.time-countdown').length) {
        $('.time-countdown').each(function () {
            ...
            $this.countdown(finalDate, function (event) {
                var $this = $(this).html(event.strftime('' + '<div class="counter-column"><span class="count">%D</span>দিন</div> ' + '<div class="counter-column"><span class="count">%H</span>ঘন্টা </div>  ' + '<div class="counter-column"><span class="count">%M</span>মিনিট </div>  ' + '<div class="counter-column"><span class="count">%S</span>সেকেন্ড</div>'));
            });
        });
    }
